...
name: humanizer
description: >
  Rewrite AI-sounding text so it reads naturally without changing what it says. Run on anything shareable: email, document, wiki page, artifact, message, published page. Not for plain chat replies. Fixes inflated claims, sales language, vague sources, repetitive structure, stock AI words, passive voice, filler, and chatbot artifacts.
license: MIT
metadata:
  version: "2.11.2"
---
